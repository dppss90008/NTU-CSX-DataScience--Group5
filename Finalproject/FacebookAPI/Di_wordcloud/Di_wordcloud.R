...
# ==== 丁守中
# ---- Jan
docs <- Corpus(VectorSource(Di_data$post[214:266]))
...
# ---- Feb
docs <- Corpus(VectorSource(Di_data$post[163:213]))
toSpace <- content_transformer(function(x,pattern){
  return(gsub(pattern," ",x))
})
# 刪去單詞贅字、英文字母、標點符號、數字與空格
...
# ---- Mar
docs <- Corpus(VectorSource(Di_data$post[115:162]))
toSpace <- content_transformer(function(x,pattern){
  return(gsub(pattern," ",x))
})
# 刪去單詞贅字、英文字母、標點符號、數字與空格
...
# ---- Apr
docs <- Corpus(VectorSource(Di_data$post[62:114]))
toSpace <- content_transformer(function(x,pattern){
  return(gsub(pattern," ",x))
})
# 刪去單詞贅字、英文字母、標點符號、數字與空格
...
# ---- May
docs <- Corpus(VectorSource(Di_data$post[20:61]))
toSpace <- content_transformer(function(x,pattern){
  return(gsub(pattern," ",x))
})
# 刪去單詞贅字、英文字母、標點符號、數字與空格
