...
# ==== 柯文哲
# ---- Jan
docs <- Corpus(VectorSource(Ko_data$post[121:138]))
...
# ---- Feb
docs <- Corpus(VectorSource(Ko_data$post[94:120]))
toSpace <- content_transformer(function(x,pattern){
  return(gsub(pattern," ",x))
})
# 刪去單詞贅字、英文字母、標點符號、數字與空格
...
# ---- Mar
docs <- Corpus(VectorSource(Ko_data$post[65:93]))
toSpace <- content_transformer(function(x,pattern){
  return(gsub(pattern," ",x))
})
# 刪去單詞贅字、英文字母、標點符號、數字與空格
...
# ---- Apr
docs <- Corpus(VectorSource(Ko_data$post[34:64]))
toSpace <- content_transformer(function(x,pattern){
  return(gsub(pattern," ",x))
})
# 刪去單詞贅字、英文字母、標點符號、數字與空格
...
# ---- May
docs <- Corpus(VectorSource(Ko_data$post[13:33]))
toSpace <- content_transformer(function(x,pattern){
  return(gsub(pattern," ",x))
})
# 刪去單詞贅字、英文字母、標點符號、數字與空格
